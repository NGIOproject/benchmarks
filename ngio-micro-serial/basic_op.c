...
#undef ALLVOL
	...
	case '+': {
		...
		/* 'reps' number of iterations, 1 addition */
		...
		/* 'reps'/2 number of iterations, 2 additions */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			c = a+d;
			b = d+c;
		...
		/* 'reps'/4 number of iterations, 4 additions */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			c = a+d;
			b = d+c;
		...
		/* 'reps'/5 number of iterations, 5 additions */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			c = a+d;
			b = d+c;
		...
		/* 'reps'/8 number of iterations, 8 additions */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			c = a+d;
			b = d+c;
		...
		/* 'reps'/10 number of iterations, 10 additions */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			c = a+d;
			b = d+c;
	...
	case '-': {
		...
		/* 'reps' number of iterations, 1 subtraction */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			c = a-b;
		}
		...
		/* 'reps'/2 number of iterations, 2 subtractions */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			c = a-b;
			a = b-c;
		...
		/* 'reps'/4 number of iterations, 4 subtractions */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			c = a-b;
			a = b-c;
		...
		/* 'reps'/5 number of iterations, 5 subtractions */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			c = a-b;
			a = b-c;
		...
		/* 'reps'/8 number of iterations, 8 subtractions */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			c = a-b;
			a = b-c;
		...
		/* 'reps'/10 number of iterations, 10 subtractions */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			c = a-b;
			a = b-c;
	...
	case '*': {
		...
		/* 'reps' number of iterations, 1 multiplication */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			c = a*b;
		}
		...
		/* 'reps'/2 number of iterations, 2 multiplications */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			c = a*b;
			a = b*c;
		...
		/* 'reps'/4 number of iterations, 4 multiplications */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			c = a*b;
			a = b*c;
		...
		/* 'reps'/5 number of iterations, 5 multiplications */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			c = a*b;
			a = b*c;
		...
		/* 'reps'/8 number of iterations, 8 multiplications */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			c = a*b;
			a = b*c;
		...
		/* 'reps'/10 number of iterations, 10 multiplications */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			c = a*b;
			a = b*c;
	...
	case '/': {
		...
		/* 'reps' number of iterations, 1 division */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			r1 = a/b;
		}
		...
		/* 'reps'/2 number of iterations, 2 divisions */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			r1 = a/b;
			r2 = b/c;
		...
		/* 'reps'/4 number of iterations, 4 divisions */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			r1 = a/b;
			r2 = b/c;
		...
		/* 'reps'/5 number of iterations, 5 divisions */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			r1 = a/b;
			r2 = b/c;
		...
		/* 'reps'/8 number of iterations, 8 divisions */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			r1 = a/b;
			r2 = b/c;
		...
		/* 'reps'/10 number of iterations, 10 divisions */
		clock_gettime(CLOCK, &start);
		for(i=0; i<reps; i++){
			r1 = a/b;
			r2 = b/c;
