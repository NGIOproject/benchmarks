...
SOURCES = main.c level0.c basic_op.c utils.c memory.c funccalls.c branch_jump.c sleep.c process.c ipc_server.c ipc_client.c net_server.c net_client.c io.c
