...
#ifdef PMEM
void bench_level1(char *, unsigned int, unsigned long, char *, char *, char *, char *);
#else
...
int float_spgemm(unsigned long);
int double_spgemm(unsigned long);
...
#ifdef PMEM
void pmem_fileparse(unsigned int, char *);
#endif
